...
def index():
    #return "<h1>hudh</h1>"
    return render_template('index/index1.html')
...
def participants():
    ...
    return render_template("index/participants.html", data=data)    

if __name__ == '__main__':
    app.run(debug=True)

# Git Bash for enabling debug mode and auto reloads when you edit code.
